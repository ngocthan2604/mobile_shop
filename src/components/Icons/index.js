const SearchIcon = ({ className }) => {
    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="5 5 14 14" width="16" height="16">
            <path
                fill="currentColor"
...
const ClearIcon = ({ className }) => {
    return (
        <svg width="8" height="8" viewBox="0 0 8 9" xmlns="http://www.w3.org/2000/svg">
            <path
...
const LikeIcon = ({ className }) => {
    return (
        <svg
            ...
            data-bbox="5.3 23.175 189.725 160.625"
            viewBox="5.3 23.175 189.725 160.625"
            height="23"
            width="26"
            xmlns="http://www.w3.org/2000/svg"
            data-type="shape"
            role="img"
            aria-labelledby="svgcid--399tvycl5f1k"
        >
            <g>
                <path d="M181.3 37c-18.3-18.3-47.8-18.3-66.1 0l-14.9 14.9-15-15c-18.3-18.3-47.8-18.3-66.1 0C.7 55.2.7 84.5 19 102.8l81.1 81 81.2-80.9c18.3-18.2 18.3-47.6 0-65.9z"></path>
            </g>
        </svg>
    );
};
...
const BikeIcon = ({ className }) => {
    return (
        <svg
            ...
            role="presentation"
            aria-hidden="true"
            aria-labelledby="svgcid-dg2gs9-xqne8n"
        >
            <g>
                <path
...
const ShipIcon = ({ className }) => {
    return (
        <svg
            ...
            role="presentation"
            aria-hidden="true"
            aria-labelledby="svgcid--2b798e-jif9e3"
        >
            <g>
                <path
...
const PricesIcon = ({ className }) => {
    return (
        <svg
            ...
            role="presentation"
            aria-hidden="true"
            aria-labelledby="svgcid-qatzoa65jbqm"
        >
            <g>
                <path
...
const ClockIcon = ({ className }) => {
    return (
        <svg
            ...
            role="presentation"
            aria-hidden="true"
            aria-labelledby="svgcid-uymro4-bsespn"
        >
            <g>
                <path
...
const TriangleImage = ({ className, color, height }) => {
    return (
        <svg
            preserveAspectRatio="none"
            data-bbox="82.1 22.8 35.8 154.4"
            viewBox="82.1 22.8 35.8 154.4"
            height={height}
            width="150"
            xmlns="http://www.w3.org/2000/svg"
            data-type="shape"
        ...
        >
            <g>
                <path d="M112.8 177.2h5.1V22.8H82.1l30.7 154.4z"></path>
            </g>
        </svg>
    );
};
